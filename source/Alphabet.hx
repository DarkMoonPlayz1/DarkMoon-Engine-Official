...
class Alphabet extends FlxSpriteGroup
{
	...
	public var isFreePlayTextState:Bool = false;
	...
	override function update(elapsed:Float)
	{
		...
		if (isFreePlayTextState)
		{
			var scaledY = FlxMath.remapToRange(targetX, 15, 0, 0, 1.3);

			y = FlxMath.lerp(y, (scaledY * -50) + (FlxG.height * 0.48), 0.30);
			x = FlxMath.lerp(x, (targetY * 940) + 120, 0.40);
		}
